...
## ⚙️ V. Zarządzanie Konfiguracją (`.env` & `testConfig`)
...
## 🏗️ VI. Hierarchia i Architektura Frameworka
...
## 🛡️ VII. Quality Gate & Standardy Kodu
...
## 📊 VIII. Raportowanie (Allure Report)
